...
all: ${BIN}/integrate-phi-q2nuzhpt2 ${BIN}/bgreduction-pt2-q2nuzh ${BIN}/calculate-meanpt2 ${BIN}/calculate-broadening \
	 ...
	 ${BIN}/print-plot-acccorr-accrccorr-comparison ${BIN}/rcfactors-fix-fit
...
${BIN}/rcfactors-fix-fit: ${SRC}/rcfactors-fix-fit.cpp
	${CXX} -I${INC} ${ROOTCFLAGS} ${SRC}/rcfactors-fix-fit.cpp -o ${BIN}/rcfactors-fix-fit ${ROOTLIBS}
