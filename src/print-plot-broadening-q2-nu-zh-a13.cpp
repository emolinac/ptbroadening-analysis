...
int main(int argc, char *argv[])
{
    ...
    {
        h[targ]    = (TH1F*) fin->Get(get_broadening_histo_name(targ).c_str());
        h_Q2[targ] = (TH1F*) fin->Get(get_broadening_Q2_histo_name(targ).c_str());
        h_Nu[targ] = (TH1F*) fin->Get(get_broadening_Nu_histo_name(targ).c_str());
        h_Zh[targ] = (TH1F*) fin->Get(get_broadening_Zh_histo_name(targ).c_str());
